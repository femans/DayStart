...
<template>
  <div v-if="pagePlan" class="flex items-center flex-grow">
    ...
    <div class="relative flex-grow">
      <DSValidatedInput
        ...
        :class="{
          ...
          'pr-8': pagePlan.documentation_url && isValidUrl && !isFocused, // Add padding for the button
        }"
        :disabled="pagePlan.archived"
        placeholder="Documentation URL"
        class="w-full rounded-md border border-gray-200 p-1 text-sm dark:border-gray-800"
